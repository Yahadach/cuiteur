<?php
	...
	echo "<p id=titre>Les abonnements de $profil_pseudo </p>",
	...
	echo '<div id="abonner">',
		...
		echo '<form method="POST" action="abonnements.php?profil=',$id_encrypted,'&amp;pseudo=',$pseudo_encrypted,'&amp;nom=',$nom_encrypted,'">';
